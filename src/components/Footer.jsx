...
export default function Footer() {
  ...
  return (
    <footer style={{ background: 'var(--on-surface)', padding: '5rem 2rem 2.5rem' }}>
      <div style={{ maxWidth: 1280, margin: '0 auto', display: 'grid', gridTemplateColumns: '2fr 1fr 1fr 1fr', gap: '4rem', paddingBottom: '4rem', borderBottom: '1px solid rgba(255,255,255,0.07)', marginBottom: '2rem' }}>
        <div>
